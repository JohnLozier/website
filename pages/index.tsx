...
const Index = () => {
	return <div class="flex w-full h-full justify-center items-center select-none">
		<div class="w-2/6 max-h-5/6 pb-5 min-w-min bg-slate-100 rounded-2xl flex flex-col shadow-2xl">
			<h1 class="text-4xl  mt-8 font-montserrat font-bold text-center text-gray-700">Sorry we are down for maintenance</h1>
			...
			<h3 class="text-1.5xl mt-5 font-opensans text-center mx-5 text-gray-500">In the meantime you can go check out my new project <Link class="text-blue-700 duration-300 hover:opacity-60 opacity-50" href="/codetyper">CodeTyper</Link> or my <Link class="text-blue-700 hover:opacity-60 transition-opacity duration-300 opacity-50" href="https://github.com/JohnLozier">Github</Link>!</h3>
		</div>
	</div>
};
