	...
	return (
		<div id={ styles.container }>
			...
			<div id={ styles.projects }>
				...
				<Project title="Crypto Prices" text="Crypto Prices is another chrome and firefox extension that makes it easy to quickly check crypto prices. Its features include dark mode, useful links, and a 7 day graph. I originally created it after I was sick of having to search up individual currency's on finance sites, so I decided to spend a few days solving this issue. The first version was frankly very bad, so a few months later I re-did it with my updated skills. I may remake it for a 3rd time in the future if I'm, ever bored, but probably not." image={ CryptoPrices } repo="J-The-Dev/cryptoPrices"/>
