...
const Index = () => {
	return <div class="flex w-full h-full justify-center items-center select-none">
		<div class="w-2/6 h-5/6 bg-slate-100 rounded-2xl flex flex-col shadow-lg">
			...
			<h3 class="text-2xl mt-5 font-opensans text-center mx-5 text-gray-500">In the meantime you can go check out my new project <a class="text-blue-700 opacity-50" href="/codetyper">CodeTyper</a> or my <a class="text-blue-700 opacity-50" href="https://github.com/JohnLozier">Github</a>!</h3>
		</div>
	</div>
};
