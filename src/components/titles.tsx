const Title = () => {
	return <>
		...
		<h1 class="w-fit animate-name animation-delay-100 select-none sm:text-7xl md:text-8xl lg:text-12xl pointer uppercase font-montserrat text-transparent font-extrabold text-4xl leading-none bg-gradient-to-br from-cyan-300 to-sky-600 bg-clip-text drop-shadow-title hover:drop-shadow-titleHover transition-[transform, filter] duration-500 hover:-translate-y-2 whitespace-nowrap">John Lozier</h1>	
