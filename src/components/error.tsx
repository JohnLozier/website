...
const Error = () => {
	...
	return <div ref={ Error! } class="absolute animate-slide-down bg-red-400 animation-delay-500 -translate-y-full hidden w-full items-center justify-center transition-transform duration-500 top-0">
