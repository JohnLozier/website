...
import { Resource, lazy } from "solid-js";
...
const Content = (props: { content: Resource<FrontMatterResult<Markdown>> }) => {
	...
	return <>
		<div class="my-8">
			<h1 class="text-4xl xsm:text-5xl sm:text-7xl font-black animate-appear drop-shadow-[0_10px_8px_#0000004d] font-montserrat w-min text-gray-800 uppercase mb-3">{ props.content()?.attributes.title }</h1>
			<Line />
